        ...
        <Grid container className={classes.bodyWrapper}>
            ...
            <Grid item className={classes.leftContent}>
                <Typography variant="h4" component="h1" className={classes.title}>
                    Decentralized and Distributed Blockchain Based Voting
                </Typography>
                ...
                <FormControl variant="outlined" className={classes.formControl}>
                    ...
                    <option value={"1"}>US Elections</option>
                    <option value={"2"}>Wakanda Elections</option>
                    <option value={"3"}>Narnia Elections</option>
                    </Select>
                </FormControl>
                <Link to={`/vote/${campaign}`} className={classes.link}>
                    <Button variant="contained" className={classes.voteButton}>VOTE NOW</Button>
                </Link>
                </Grid>
            </Grid>
